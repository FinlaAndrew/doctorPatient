package com.ust.appointment.exception.advice;
...
import com.ust.appointment.exception.dto.ApiError;
import com.ust.appointment.exception.dto.ApiValidationError;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleDoctorNotFoundException(AppointmentNotFoundException ex) {
        return buildResponseEntity(new ApiError(HttpStatus.NOT_FOUND, ex));
    }
    @ExceptionHandler(AppointmentAlreadyExistException.class)
    protected ResponseEntity<Object> handleDoctorAlreadyExistException(AppointmentAlreadyExistException ex) {
